...
export const seedVisits: Visit[] = [
  ...
  { id: "v2", clientName: "Edward Pham", clientPersonId: "c-edward", service: "Live-In", caregiverName: "Vanessa", startsAt: at(0, 16), endsAt: at(1, 0) },
  { id: "v3", clientName: "Dolores Vance", clientPersonId: "c-dolores", service: "Evening Care", caregiverName: "Thylia", startsAt: at(1, 18, 30), endsAt: at(1, 22, 30) },
  ...
  { id: "v5", clientName: "Ruth Alvarez", clientPersonId: "c-ruth", service: "Companion Care", caregiverName: null, startsAt: at(2, 12), endsAt: at(2, 18) },
  { id: "v6", clientName: "Evelyn Carter", clientPersonId: "c-evelyn", service: "Dementia Care", caregiverName: null, startsAt: at(4, 9), endsAt: at(4, 13) },
  ...
  { id: "v7", clientName: "Edward Pham", clientPersonId: "c-edward", service: "Live-In", caregiverName: "Vanessa", startsAt: at(3, 16), endsAt: at(4, 0) },
