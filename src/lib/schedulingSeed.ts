...
export const seedVisits: Visit[] = [
  { id: "v1", clientName: "Lian Huang", service: "Personal Care", caregiverName: "Chanel P.", startsAt: at(0, 8), endsAt: at(0, 12) },
  { id: "v2", clientName: "Edward Pham", service: "Live-In", caregiverName: "Vanessa", startsAt: at(0, 16), endsAt: at(1, 0) },
  { id: "v3", clientName: "Dolores Vance", service: "Evening Care", caregiverName: "Thylia", startsAt: at(1, 18, 30), endsAt: at(1, 22, 30) },
  { id: "v4", clientName: "Lian Huang", service: "Personal Care", caregiverName: "Chanel P.", startsAt: at(2, 8), endsAt: at(2, 12) },
  ...
  { id: "v7", clientName: "Edward Pham", service: "Live-In", caregiverName: "Vanessa", startsAt: at(3, 16), endsAt: at(4, 0) },
  { id: "v8", clientName: "Susan Miller", service: "Personal Care", caregiverName: "Vanessa", startsAt: at(3, 18), endsAt: at(3, 21) },
